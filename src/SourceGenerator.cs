...
{{
    ...
    {{
        ...
        {(isDeserialization ? FromHashEntries(contextOptions, typeOptions) : "")}
        {(isSerialization ? GetHashEntries(contextOptions, typeOptions) : "")}
...
{{
    ...
    {{
        ...
        private static string GetHashEntries(ContextOptions contextOptions, ObjectOptions typeOptions)
        {
...
";
        ...
        private static string FromHashEntries(ContextOptions contextOptions, ObjectOptions typeOptions)
        {
            return $@"/// <summary>
